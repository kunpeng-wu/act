    ...
    def __getitem__(self, index):
        ...
        with h5py.File(dataset_path, 'r') as root:
            ...
            for cam_name in self.camera_names:
                image_dict[cam_name] = root[f'/observations/images/{cam_name}'][start_ts]   # {'top':(480,640,3)}
...
def get_norm_stats(dataset_dir, num_episodes):
    ...
    all_qpos_data = torch.stack(all_qpos_data)  # (16,400,14)
    all_action_data = torch.stack(all_action_data)  # (16,400,14)
